...
namespace SmartClinic.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ime,Prezime,Email,Lozinka")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ime,Prezime,Email,Lozinka")] Korisnik korisnik)
        {
            if (id != korisnik.Id)
            {
                return NotFound();
